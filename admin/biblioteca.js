function ControleBiblioteca() {
	...
	this.listar = function () {
		//Sem CallBack
		/*let artigos = biblioteca.listar(); 
		visaoListar.listar(artigos);*/
		//Com CallBack
		/*biblioteca.listar(function (artigos) {
			visaoListar.listar(artigos);
		});*/
		//Com CallBack Resumido
		/*biblioteca.listar((artigos) => {
			visaoListar.listar(artigos);
		});*/
		...
		externo: while (true) {
			...
			switch (resposta) {
				...
				case 2:
					...
					break;
				/*case 3:
					cadastrar(biblioteca_musica);
				case 4:
					listar(biblioteca_musica);
					break;*/
				case 5:
					alert('Sair');
					break externo;
...
/*let biblioteca_tecnologia = new Biblioteca();
let biblioteca_musica = new Biblioteca();*/
//Modelo - Manipular/Armazenar Dados
